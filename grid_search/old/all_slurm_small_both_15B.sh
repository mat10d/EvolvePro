...
##SBATCH -x node[110]
#SBATCH --job-name=all_slurm_small_both
#SBATCH -n 1 
#SBATCH -N 1   
##SBATCH --gres=gpu:1
...
#SBATCH --mem=10gb  
#SBATCH --output /om/group/abugoot/Projects/Matteo/Github/directed_evolution/grid_search/out/all_slurm_small_both-%j.out 

source ~/.bashrc
conda activate embeddings

datasets=("esm2_15B_giacomelli" "esm2_15B_lee" "esm2_15B_haddox" "esm2_15B_jones")
num_simulations=10
