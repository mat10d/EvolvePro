...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Encode protein sequences from FASTA files."
    )
    parser.add_argument(
        "fasta_file", help="Path to a FASTA file containing protein sequences"
    )
    parser.add_argument(
        "--method",
        choices=["one_hot", "integer"],
        required=True,
        help="Encoding method",
    )
    parser.add_argument(
        "--results_path", default="results", help="Path to save results"
    )
...
def encode_sequences_from_fasta(
    fasta_file: str, method: str, results_path: str, verbose: bool = False
) -> pd.DataFrame:
    """
...
def main():
    ...
    encode_sequences_from_fasta(
        args.fasta_file, args.method, args.results_path, args.verbose
    )
