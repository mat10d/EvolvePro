...
output_dir = (
    "/orcd/archive/abugoot/001/Projects/Matteo/Github/EvolvePro/output/exp_plots/"
)
...
df = read_exp_data(
    round_base_path, round_file_names_single, wt_fasta_path, round_file_names_multi
)

plot_variants_by_iteration(
    df, activity_column="activity", output_dir=output_dir, output_file="t7_pol"
)
...
plot_variants_by_iteration(
    df, activity_column="activity", output_dir=output_dir, output_file="mlv"
)
...
plot_variants_by_iteration(
    df, activity_column="activity", output_dir=output_dir, output_file="bxb1"
)
