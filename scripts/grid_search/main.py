...
# python main.py --dataset_name "kelsic" --experiment_name "test" --model_name "esm1b_t33_650M_UR50S" --embeddings_path "/orcd/archive/abugoot/001/Projects/Matteo/Github/EvolvePro/output/plm/esm" --labels_path "/orcd/archive/abugoot/001/Projects/Matteo/Github/EvolvePro/output/dms" --num_simulations 3 --num_iterations 3 --measured_var fitness_scaled --learning_strategies top10 --num_mutants_per_round 16 --num_final_round_mutants 16 --first_round_strategies random --embedding_types embeddings --pca_components 10 --regression_types randomforest --embeddings_file_type csv --output_dir "/orcd/archive/abugoot/001/Projects/Matteo/Github/EvolvePro/output/grid_search"