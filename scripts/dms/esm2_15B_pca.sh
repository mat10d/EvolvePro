...
run_dms_main() {
    dataset_name=$1
    output_file="out/${dataset_name}-esm2_15B_pca.out"

    echo "Running ${dataset_name} dataset:" > ${output_file}
    python3 -u dms_main.py \
        --dataset_name ${dataset_name} \
        --experiment_name "esm2_15B_pca" \
        ...
        --embedding_types "embeddings" "embeddings_pca_10" "embeddings_pca_50" "embeddings_pca_500" "embeddings_pca_1000" \
        --pca_components 10 50 500 1000 \
