...
from evolvepro.src.process import (
    process_dataset,
    plot_mutations_per_position,
    plot_histogram_of_readout,
    preprocess_cas12f,
    preprocess_zikv_E,
    preprocess_cov2_S,
    markin_custom_cutoff,
)
...
wt_fasta_path = os.path.join(
    project_root, "data", "dms", "wt_fasta", "giacomelli_WT.fasta"
)
...
wt_fasta_path = os.path.join(
    project_root, "data", "dms", "wt_fasta", "stiffler_WT.fasta"
)
...
file_path = os.path.join(
    project_root, "data", "dms", "activity", "abf8761_markin_data-s1.csv"
)
dataset_name = "markin"
...
wt_fasta_output = os.path.join(
    project_root, "data", "dms", "wt_fasta", "cas12f_WT.fasta"
)
preprocessed_output_file = os.path.join(
    project_root, "data", "dms", "activity", "DMS_AsCas12f_preprocessed.xlsx"
)
...
input_file = os.path.join(
    project_root, "data", "dms", "activity", "jvi.01291-19-sd003.xlsx"
)
wt_fasta_output = os.path.join(
    project_root, "data", "dms", "wt_fasta", "zikv_E_WT.fasta"
)
preprocessed_output_file = os.path.join(
    project_root, "data", "dms", "activity", "zikv_E_preprocessed.xlsx"
)
...
# Cov2_S
input_file = os.path.join(
    project_root, "data", "dms", "activity", "all_samples_raw_data--sarscov2.csv"
)
preprocessed_output_file = os.path.join(
    project_root, "data", "dms", "activity", "sarscov2_preprocessed.csv"
)
...
background_df.to_csv(
    os.path.join(project_root, "output", "dms", "background_df.csv"),
    index_label="dataset",
)
